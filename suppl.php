	...
	<!-- header -->
    	...
    	<header role="header" class="header-top" id="headere-top">
                    ...
                    <hgroup class="row">
                        ...
                        <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                            ...
                            <h1>
                                ...
                                <a href="#headere-top" title="Rooky"><img src="" alt="Cockatiel" title="cock"/></a>
                            ...
                            <div id="navbar" class="navbar-collapse collapse">            
                                ...
                                <ul class="nav navbar-nav">			          
                                  ...
                                  <li class="active"><a href="#headere-top" title="Home">Home</a></li>
                                    ...
                                    <li><a href="index.php" title="Overview">About Us</a></li>

                                    <li><a href="index.php" title="Features">Introduction</a></li>
                                    ...
                                    <li><a href="index.php" title="Join Us">Get in Touch</a></li>           
        	...
        	<figure>
            	...
            	<div class="parallax-window item tp-banner-container" data-parallax="scroll" data-image-src="images/img1.jpg"></div>
